...
from model.vector_precomputed import build_attention_and_aggregated_features_lstm_with_vector_input_precomputed
...
if __name__ == '__main__':
    hps = HyperparamSearch(config=config,
                           ...
                           get_model_fn=build_attention_and_aggregated_features_lstm_with_vector_input_precomputed,
                           get_data_generator_fn=initialize_datasets_precomputed_group_of_vectors_sequence,
