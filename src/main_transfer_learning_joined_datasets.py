...
if __name__ == '__main__':
    ...
    all_data_source_domain1, subjects_split_source_domain1 = load_erisk_data(writings_df)

    all_data_source_domain2, subjects_split_source_domain2 = load_daic_data(path_train="../data/daic-woz/train_data.json",
    ...
    all_data_source_domain = {**all_data_source_domain1, **all_data_source_domain2} # different keys, possible to merge automatically
    subjects_split_source_domain = {'train': subjects_split_source_domain1["train"] + subjects_split_source_domain2["train"],
                                    'valid': subjects_split_source_domain1["valid"] + subjects_split_source_domain2["valid"],
                                    'test': subjects_split_source_domain1["test"] + subjects_split_source_domain2["test"]}
    ...
    if args.model == "hierarchical" or args.model == "hierarchicalRandom":
        ...
        hyperparams_features = {"embeddings_name": args.embeddings, "embedding_dim": args.embeddings_dim,
                                "precomputed_vectors_path": f"../data/joined/precomputed_features/"}
