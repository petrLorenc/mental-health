...
if __name__ == '__main__':
    ...
    model_path = f'../resources/models/{model}_{embeddings}_{args.version}{"_" + args.note if args.note else args.dataset}'
    ...
    for experiment in opt.get_experiments(project_name=f"daic-woz-optimization"):
        ...
        hyperparams["dense_units"] = experiment.get_parameter("dense_units")
        hyperparams["dropout_rate"] = experiment.get_parameter("dropout_rate")
