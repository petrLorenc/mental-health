...
#python main.py --dataset eRisk --model log_regression_unigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/unigrams_20000.txt --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model log_regression_unigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/unigrams_20000.txt.original --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model log_regression_unigrams_features --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/unigrams_20000.txt --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model log_regression_bigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/bigrams_20000.txt --note eRisk-bigrams-20000
#
## neural networks variants
#python main.py --dataset eRisk --model neural_network_unigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/unigrams_20000.txt --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model neural_network_unigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/unigrams_20000.txt.original --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model neural_network_unigrams_features --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/unigrams_20000.txt --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model neural_network_bigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_erisk/bigrams_20000.txt --note eRisk-bigrams-20000
#
## HAN
#python main.py --dataset eRisk --model hierarchical --epochs 50 --only_test False --smaller_data False --version 1 --vocabulary ../generated/vocab_daic/unigrams_20000.txt --note eRisk-unigrams-20000
#python main.py --dataset eRisk --model hierarchical --epochs 50 --only_test False --smaller_data False --version 1 --vocabulary ../generated/vocab_daic/unigrams_20000.txt.original --note eRisk-unigrams-20000
...
# USE5
python precompute_features_tfh.py --dataset eRisk --code use5 --name "../resources/embeddings/use-5" --dimension 512
...
# XLNet - not possible because of size
...
# BERT
python precompute_features_tf.py --dataset eRisk --code bert --name "bert-base-cased" --dimension 768
