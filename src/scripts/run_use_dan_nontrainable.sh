...
python main.py --dataset daic --model lstm_vector_dan --embeddings use-vector --epochs 50 --only_test False --smaller_data False --version 1 --note daic_use_dan_nontrainable
