...
python main.py --dataset daic-woz --model log_regression_unigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_daic/unigrams_participant_3123.txt --note eRisk-unigrams-3123
python main.py --dataset daic-woz --model log_regression_unigrams_features --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_daic/unigrams_participant_3123.txt --note eRisk-unigrams-3123
python main.py --dataset daic-woz --model log_regression_bigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_daic/bigrams_participant_3123.txt --note eRisk-bigrams-3123
python main.py --dataset daic-woz --model log_regression_bigrams --epochs 50 --only_test False --smaller_data False --version 1 --vocabulary ../generated/vocab_daic/bigrams_participant_16385.txt --note eRisk-bigrams-16385

# neural networks variants
python main.py --dataset daic-woz --model neural_network_unigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_daic/unigrams_participant_3123.txt --note eRisk-unigrams-3123
python main.py --dataset daic-woz --model neural_network_unigrams_features --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_daic/unigrams_participant_3123.txt --note eRisk-unigrams-3123
python main.py --dataset daic-woz --model neural_network_bigrams --epochs 50 --only_test False --smaller_data False --version 1  --vocabulary ../generated/vocab_daic/bigrams_participant_3123.txt --note eRisk-bigrams-3123
python main.py --dataset daic-woz --model neural_network_bigrams --epochs 50 --only_test False --smaller_data False --version 1 --vocabulary ../generated/vocab_daic/bigrams_participant_16385.txt --note eRisk-bigrams-16385

# HAN
python main.py --dataset daic-woz --model hierarchical --epochs 50 --only_test False --smaller_data False --version 1 --vocabulary ../generated/vocab_daic/unigrams_participant_3123.txt --note eRisk-unigrams-3123

# precomputed vectors
# USE4
python precompute_features_tfh.py --dataset daic-woz --code use4 --name "../resources/embeddings/use-4" --dimension 512 --aggregation vstack
...
python precompute_features_tfh.py --dataset daic-woz --code use4 --name "../resources/embeddings/use-4" --dimension 512 --aggregation average
...
python precompute_features_tfh.py --dataset daic-woz --code use4 --name "../resources/embeddings/use-4" --dimension 512 --aggregation maximum
...
python precompute_features_tfh.py --dataset daic-woz --code use4 --name "../resources/embeddings/use-4" --dimension 512 --aggregation minimum
...
# USE5
python precompute_features_tfh.py --dataset daic-woz --code use5 --name "../resources/embeddings/use-5" --dimension 512 --aggregation vstack
...
python precompute_features_tfh.py --dataset daic-woz --code use5 --name "../resources/embeddings/use-5" --dimension 512 --aggregation average
...
python precompute_features_tfh.py --dataset daic-woz --code use5 --name "../resources/embeddings/use-5" --dimension 512 --aggregation maximum
...
python precompute_features_tfh.py --dataset daic-woz --code use5 --name "../resources/embeddings/use-5" --dimension 512 --aggregation minimum
...
python main.py --dataset daic-woz --model precomputed_embeddings_sequence_lstm --embeddings bertweet.vstack --embeddings_dim 768 --epochs 50 --only_test False --smaller_data False --version 1
python precompute_features_tfh.py --dataset daic-woz --code bertweet --name "vinai/bertweet-base" --dimension 768 --aggregation average --cls_position 0
...
python precompute_features_tfh.py --dataset daic-woz --code bertweet --name "vinai/bertweet-base" --dimension 768 --aggregation average --cls_position -1
python main.py --dataset daic-woz --model precomputed_embeddings_aggregated_neural_network --embeddings bertweet.average --embeddings_dim 768 --epochs 50 --only_test False --smaller_data False --version 1
python main.py --dataset daic-woz --model precomputed_embeddings_aggregated_logistic_regression --embeddings bertweet.average --embeddings_dim 768 --epochs 50 --only_test False --smaller_data False --version 1


# BERT
python precompute_features_tf.py --dataset daic-woz --code bert --name "bert-base-cased" --dimension 768 --aggregation vstack
python main.py --dataset daic-woz --model precomputed_embeddings_sequence_lstm --embeddings use5.vstack --embeddings_dim 768 --epochs 50 --only_test False --smaller_data False --version 1
python precompute_features_tf.py --dataset daic-woz --code bert --name "bert-base-cased" --dimension 768 --aggregation average
...
python precompute_features_tf.py --dataset daic-woz --code bert --name "bert-base-cased" --dimension 768 --aggregation maximum
...
python precompute_features_tf.py --dataset daic-woz --code bert --name "bert-base-cased" --dimension 768 --aggregation minimum
