...
hyperparams_features = {
    ...
    "embeddings_name": "bigrams",
    "vocabulary_path": f"/home/petlor/mental-health/code/resources/generated/vocab_daic/bigrams_participant_6000.txt",
    "embedding_dim": 6002
}
...
if __name__ == '__main__':
    hps = HyperparamSearch(config=config,
                           ...
                           get_data_generator_fn=initialize_datasets_bigrams,
